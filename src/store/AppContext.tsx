...
function draftToDetail(d: WizardDraft) {
  return {
    ...
    dealerSubventionAmt: d.dealerSubventionAmt ?? null,
    mfgSubventionPct: d.mfgSubventionPct ?? null,
    mfgSubventionAmt: d.mfgSubventionAmt ?? null,
    ...
    setPromos((prev) =>
      prev.map((p) => {
        ...
        const pendingEdit: PendingEdit = {
          ...
          dealerSubventionAmt: form.dealerSubventionAmt,
          mfgSubventionPct: form.mfgSubventionPct,
          mfgSubventionAmt: form.mfgSubventionAmt,
      ...
      prev.map((p) => {
        ...
        const newDetail: PromoDetail | undefined = existingDet
          ? {
              ...
              dealerSubventionAmt: e.dealerSubventionAmt ?? null,
              mfgSubventionPct: e.mfgSubventionPct ?? null,
              mfgSubventionAmt: e.mfgSubventionAmt ?? null,
